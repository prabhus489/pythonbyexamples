...
goals = """
The goals are:
    a. Each of the examples explains a specific feature in Python.
    b. Keep it simple
    c. Show code and take about it in very few lines
    d. Provide try-it-yourself so that you can try to develop/extend the example\n"""
...
greetings = "Wish you good luck and hope this project will be useful to you\n"
